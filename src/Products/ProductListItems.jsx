...
function ProductListItems({ ProductDetail }) {
  ...
  return (
    <>
      <div className="relative m-3 h-full min-h-[16rem] w-60 scale-95 transform rounded-lg border-2 border-solid border-gray-200 p-3 transition-transform duration-300 hover:scale-100 hover:shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)]">
        ...
        <div>
          ...
          <div className="flex justify-between text-lg font-semibold text-[#DB4444]">
            ${ProductDetail?.price}
            <span
              className="cursor-pointer text-xs underline"
              onClick={() =>
                setIndividualProductDetail(!individualProductDetail)
              }
            >
              <a>view detail</a>
            </span>
          ...
          <div className="mt-2 flex w-full justify-between">
            <Button
              ...
              onClick={() => {
                dispatch(setCartInfo(ProductDetail));
